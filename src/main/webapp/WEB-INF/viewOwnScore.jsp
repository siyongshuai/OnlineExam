...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/admin/viewOwnScore.js"></script>
</head>
...
<body>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td><input type="text" name="query_viewOwnScore_pid"
						id="query_viewOwnScore_pid" class="easyui-combobox"></td>
				</tr>
				<tr>
	...
	<div style="margin-top: 10px;">
		<table id="viewOwnScore_dg" style="height: 600px"></table>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tbody>
						<tr>
							...
							<td><input type="text" name="qtype"
								id="viewOwnScore_fm_qtype" class="easyui-combobox "
								required="true"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="qlevel"
								id="viewOwnScore_fm_qlevel" class="easyui-combobox"
								required="true"></td>
						</tr>
						<tr>
							<th scope="row">试题来源</th>
							<td><input type="text" name="qfrom"
								id="viewOwnScore_fm_qfrom" class="easyui-combobox"
								required="true"></td>
						</tr>
						<tr>
							<th scope="row">试题状态</th>
							<td><input type="text" name="status"
								id="viewOwnScore_fm_status" class="easyui-combobox"
								required="true"></td>
						</tr>
						<tr>
						...
						<tr>
							<th scope="row">选项A</th>
							<td><input type="text" name="optiona" class="input_full"></td>
						</tr>
						<tr>
							<th scope="row">选项B</th>
							<td><input type="text" name="optionb" class="input_full"></td>
						</tr>
						<tr>
							<th scope="row">选项C</th>
							<td><input type="text" name="optionc" class="input_full"></td>
						</tr>
						<tr>
							<th scope="row">选项D</th>
							<td><input type="text" name="optiond" class="input_full"></td>
						</tr>
						<tr>
